            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        ...
                        <li><i class="fa fa-bars"></i><a href=<?php echo site_url('Aset');?>>Vendor</a></li>
                    </ul>
                </li>
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="fa fa-table"></i><a href=<?php echo site_url('Aset');?>>Karyawan</a></li>
                        <li><i class="fa fa-table"></i><a href=<?php echo site_url('Aset');?>>Aset</a></li>
                    </ul>
                </li>
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa fa-th"></i><a href=<?php echo site_url('Aset');?>>Vendor</a></li>
                        <li><i class="menu-icon fa fa-th"></i><a href=<?php echo site_url('Aset');?>>Person In Charge</a></li>
                    </ul>
                </li>

                            ...
                            <section class="card">
                                ...
                                <ul class="list-group list-group-flush">
                                    <li class="list-group-item">
                                        <i class="fa fa-desktop"></i> Hardware <span class="badge badge-primary pull-right"><?php $count = $acc->countKtgLokHardware($key['ID_PERUSAHAAN'],$key['ID_LOKASI']); echo $count->row()->jml; ?></span>
                                    </li>
                                    <?php $countKtg = $acc->countSubktgLokH($key['ID_PERUSAHAAN'],$key['ID_LOKASI']); foreach ($countKtg->result_array() as $cs): ?>
                                    <li class="list-group-item">
